...
with app.app_context():
    ...
    # Initial loading of students first_name, last_name, major_id, birth_date, is_honors, student_email
    students = [
        {'student_id': '1', 'first_name': 'Robert', 'last_name':'Smith', 'major_id':3,
            'birth_date': dt.datetime(2007, 6, 1), 'is_honors':1, 'student_email':'robert.smith@example.com'},
        {'student_id': '2', 'first_name': 'Leo', 'last_name': 'Van Munching', 'major_id':6,
         'birth_date': dt.datetime(2008, 3, 24), 'is_honors': 0, 'student_email':'leo.vanmunching@example.com'},
    ]
